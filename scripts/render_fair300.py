...
A=load('/home/bluekitty/renders/cata2max300/catacombs2_crop')
B=load('/home/bluekitty/renders/catacombs2q/catacombs2_crop')
names=['CATACOMBS2-MAX  (sw64/nsf8 @448 · 300f)','CATACOMBS2  (sw32/nsf4 @518 · 300f)']
scenes=[A,B]
...
fig.suptitle("FAIR TEST — identical first 300 frames · only the settings differ", fontsize=15, y=0.995)
...
out='/mnt/e/wsl_deploy/topography_fair300.png'
